...
@torch.no_grad()
def construct_flow_training_pair(
    x0: torch.Tensor,
    noise: torch.Tensor,
...
def flow_matching_pair(
    ...
    *,
    ...
    """Backward-compatible alias for :func:`construct_flow_training_pair`."""
    return construct_flow_training_pair(x0, noise, timestep, sigma_min, backend=backend)


__all__ = [
    "construct_flow_training_pair",
    "flow_matching_pair",
    "fused_flow_matching_available",
]
